...
sudo bash -c 'echo "//$0.file.core.windows.net/$1	/sftp/ecom	cifs	nofail,vers=3.0,username=$0,password=$2,dir_mode=0777,file_mode=0777,serverino" >> /etc/fstab' $ACCOUNT $CONTAINER $STORAGEPASS
